                        ...
                        {cardData.map((data, index) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    {
                                        true  ? (
                                            <Typography style={{ fontWeight: 400 }}> <CaretUpOutlined style={{ color: 'greenyellow' }} /> ${data.price}</Typography>
                                        ) :
                                            (
                                                <Typography style={{ fontWeight: 400 }}> <CaretDownOutlined style={{ color: 'red' }} /> ${data.price}</Typography>
                                            )
                                    }
